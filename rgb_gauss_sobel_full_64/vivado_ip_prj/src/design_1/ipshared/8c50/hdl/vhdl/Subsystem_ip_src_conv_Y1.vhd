-- -------------------------------------------------------------
-- 
-- File Name: C:\Projects\fusion2_HWaccel_IP\rgb_gauss_sobel_full_64\hdlsrc\rgb_gauss_sobel_64bit_full\Subsystem_ip_src_conv_Y1.vhd
...
-- Source Path: rgb_gauss_sobel_64bit_full/Subsystem/conv_core_sobel1/Subsystem1/conv Y1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_src_conv_Y1 IS
...
END Subsystem_ip_src_conv_Y1;


ARCHITECTURE rtl OF Subsystem_ip_src_conv_Y1 IS

  -- Signals
  SIGNAL enb_gated                        : std_logic;
  SIGNAL Image_R_unsigned                 : vector_of_unsigned8(0 TO 8);  -- uint8 [9]
  SIGNAL coeffsY_signed                   : vector_of_signed8(0 TO 8);  -- int8 [9]
  ...
  SIGNAL Delay5_out1_last_value           : unsigned(7 DOWNTO 0);  -- uint8
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay5_out1_last_value <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_gated = '1' THEN
        Delay5_out1_last_value <= Delay5_out1_1;
      END IF;
    END IF;
  ...
  Delay5_out1_1 <= Delay5_out1_last_value WHEN alphavalid = '0' ELSE
      Delay5_out1;

  RY <= std_logic_vector(Delay5_out1_1);
  ...
  LY <= std_logic_vector(Delay4_out1_1);
