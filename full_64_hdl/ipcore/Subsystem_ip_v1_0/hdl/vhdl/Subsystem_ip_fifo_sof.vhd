-- -------------------------------------------------------------
-- 
-- File Name: C:\Projects\ipcore_integration_v2\full_64_hdl\hdlsrc\gauss_sobel_rgb_64bit_full\Subsystem_ip_fifo_sof.vhd
...
-- Source Path: Subsystem_ip/Subsystem_ip_axi4_stream_video_slave/Subsystem_ip_fifo_sof
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_fifo_sof IS
...
END Subsystem_ip_fifo_sof;


ARCHITECTURE rtl OF Subsystem_ip_fifo_sof IS
...
BEGIN
  ...
  u_Subsystem_ip_fifo_sof_classic_ram : Subsystem_ip_SimpleDualPortRAM_singlebit
