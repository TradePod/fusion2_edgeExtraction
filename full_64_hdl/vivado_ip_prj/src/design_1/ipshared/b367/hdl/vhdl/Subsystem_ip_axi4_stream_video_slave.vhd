-- -------------------------------------------------------------
-- 
-- File Name: C:\Projects\ipcore_integration_v2\full_64_hdl\hdlsrc\gauss_sobel_rgb_64bit_full\Subsystem_ip_axi4_stream_video_slave.vhd
...
-- Source Path: Subsystem_ip/Subsystem_ip_axi4_stream_video_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_axi4_stream_video_slave IS
...
END Subsystem_ip_axi4_stream_video_slave;


ARCHITECTURE rtl OF Subsystem_ip_axi4_stream_video_slave IS

  -- Component Declarations
  COMPONENT Subsystem_ip_fifo_eol
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_fifo_sof
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT Subsystem_ip_adapter_in
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_fifo_eol
    USE ENTITY work.Subsystem_ip_fifo_eol(rtl);

  FOR ALL : Subsystem_ip_fifo_sof
    USE ENTITY work.Subsystem_ip_fifo_sof(rtl);

  FOR ALL : Subsystem_ip_adapter_in
    USE ENTITY work.Subsystem_ip_adapter_in(rtl);

  FOR ALL : Subsystem_ip_fifo_data
    USE ENTITY work.Subsystem_ip_fifo_data(rtl);
...
BEGIN
  u_Subsystem_ip_fifo_eol_inst : Subsystem_ip_fifo_eol
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem_ip_fifo_sof_inst : Subsystem_ip_fifo_sof
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem_ip_Subsystem_ip_axi4_stream_video_slave_Subsystem_ip_adapter_in : Subsystem_ip_adapter_in
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Subsystem_ip_fifo_data_inst : Subsystem_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
