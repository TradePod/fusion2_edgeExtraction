-- -------------------------------------------------------------
-- 
-- File Name: C:\Projects\ipcore_integration_v2\full_64_hdl\hdlsrc\gauss_sobel_rgb_64bit_full\Subsystem_ip.vhd
...
ARCHITECTURE rtl OF Subsystem_ip IS
  ...
  COMPONENT Subsystem_ip_axi4_stream_video_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Slave_TDATA   :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
  ...
  COMPONENT Subsystem_ip_axi4_stream_video_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Master_TREADY :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Subsystem_ip_axi4_stream_video_slave
    USE ENTITY work.Subsystem_ip_axi4_stream_video_slave(rtl);

  FOR ALL : Subsystem_ip_dut
    USE ENTITY work.Subsystem_ip_dut(rtl);

  FOR ALL : Subsystem_ip_axi4_stream_video_master
    USE ENTITY work.Subsystem_ip_axi4_stream_video_master(rtl);
  ...
  SIGNAL write_greenMax                   : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_blueMax                    : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_redMax                     : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_greenMin                   : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_blueMin                    : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_redMin                     : std_logic_vector(7 DOWNTO 0);  -- ufix8
...
BEGIN
  ...
  u_Subsystem_ip_axi_lite_inst : Subsystem_ip_axi_lite
    PORT MAP( reset => reset,
              ...
              write_greenMax => write_greenMax,  -- ufix8
              write_blueMax => write_blueMax,  -- ufix8
              write_redMax => write_redMax,  -- ufix8
              write_greenMin => write_greenMin,  -- ufix8
              write_blueMin => write_blueMin,  -- ufix8
              write_redMin => write_redMin,  -- ufix8
              reset_internal => reset_internal  -- ufix1
              );

  u_Subsystem_ip_axi4_stream_video_slave_inst : Subsystem_ip_axi4_stream_video_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_Subsystem_ip_dut_inst : Subsystem_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              greenMax => write_greenMax,  -- ufix8
              blueMax => write_blueMax,  -- ufix8
              redMax => write_redMax,  -- ufix8
              greenMin => write_greenMin,  -- ufix8
              blueMin => write_blueMin,  -- ufix8
              redMin => write_redMin,  -- ufix8
  ...
  u_Subsystem_ip_axi4_stream_video_master_inst : Subsystem_ip_axi4_stream_video_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"8963F7A9");
