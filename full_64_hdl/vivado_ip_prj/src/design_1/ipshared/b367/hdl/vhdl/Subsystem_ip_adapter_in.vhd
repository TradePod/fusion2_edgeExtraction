-- -------------------------------------------------------------
-- 
-- File Name: C:\Projects\ipcore_integration_v2\full_64_hdl\hdlsrc\gauss_sobel_rgb_64bit_full\Subsystem_ip_adapter_in.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_adapter_in
-- Source Path: Subsystem_ip/Subsystem_ip_axi4_stream_video_slave/Subsystem_ip_adapter_in
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_adapter_in IS
...
END Subsystem_ip_adapter_in;


ARCHITECTURE rtl OF Subsystem_ip_adapter_in IS

  -- Component Declarations
  COMPONENT Subsystem_ip_adapter_in_module
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_adapter_in_module
    USE ENTITY work.Subsystem_ip_adapter_in_module(rtl);

  -- Signals
  SIGNAL user_pixel_tmp                   : std_logic_vector(63 DOWNTO 0);  -- ufix64

BEGIN
  u_Subsystem_ip_Subsystem_ip_axi4_stream_video_slave_Subsystem_ip_adapter_in_Subsystem_ip_adapter_in_module : Subsystem_ip_adapter_in_module
    PORT MAP( clk => clk,
              reset => reset,
